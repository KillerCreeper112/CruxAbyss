...
public class AbyssOutpostDeactivateEvent extends Event implements Cancellable {
    ...
    public AbyssOutpostDeactivateEvent(ActiveAbyssOutpost outpost, Player player) {
