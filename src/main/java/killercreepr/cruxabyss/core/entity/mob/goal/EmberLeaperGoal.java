...
public class EmberLeaperGoal extends CruxMobModeledGoal implements Listener {
    public EmberLeaperGoal(@NotNull Mob mob) {
        ...
        sounds(new CruxGoalSounds(mob) {
            ...
            public @NotNull CreateSound attack() {
                return CreateSound.sound(Sound.ENTITY_MAGMA_CUBE_SQUISH,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, 1.5f);
            }

            @Override
            public @NotNull CreateSound hurt() {
                updateStats();
                return CreateSound.sound(Sound.ENTITY_MAGMA_CUBE_HURT,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, 1.5f);
            }

            @Override
            public @NotNull CreateSound death() {
                return CreateSound.sound(Sound.ENTITY_MAGMA_CUBE_DEATH,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, 1.5f);
            }
        });
    }
    ...
    public void updateStats(){
        ...
        AbyssWorld world = CruxCore.inst().worldManager().getWorldOrNull(mob.getWorld().key(), AbyssWorld.class);
