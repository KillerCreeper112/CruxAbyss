...
public class Sporepod extends SimpleAbyssMob {

    public Sporepod() {
        super(Crux.key("sporepod"), EntityType.PIG);
    }

    @Override
    public @Nullable Consumer<Entity> spawnFunction(@Nullable AbyssWorld world, @NotNull Location l) {
        return e ->{
            e.customName(Component.text("Sporepod"));
    ...
    public @Nullable Map<CruxAttribute, Collection<CruxAttributeModifier>> getAttributes(@Nullable AbyssWorld world, @NotNull Entity e) {
        ...
        addAttribute(map, CruxAttribute.ATTACK_DAMAGE,
                CruxAttributeModifier.baseModifier(4D * (world == null ? 1D : world.getDifficulty())));
    ...
    public @Nullable CruxMobGoal getGoal(@NotNull Mob e) {
        ...
        return new SporepodGoal(e).model(active);
    }
