    ...
    public SleeplessHorrorGoal(@NotNull Mob mob) {
        ...
        sounds(new CruxGoalSounds(mob) {
            ...
            public @NotNull CreateSound ambient() {
                return CreateSound.sound(Sound.ENTITY_VEX_AMBIENT,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, .6f);
            }
            ...
            public @NotNull CreateSound hurt() {
                return CreateSound.sound(Sound.ENTITY_VEX_HURT,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, .6f);
            }

            @Override
            public @NotNull CreateSound death() {
                return CreateSound.sound(Sound.ENTITY_VEX_DEATH,  net.kyori.adventure.sound.Sound.Source.HOSTILE,0.4f, .6f);
            }
        });
